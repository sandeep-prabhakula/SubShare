            ...
            <Row className="w-75 m-auto mt-5">
                ...
                <Col>
                    <span className="d-block mt-5">
                        <span className="fw-bold">Subshare</span> is the best solution to <span className="fw-bold">share the cost of your subscriptions</span> and monthly expenses.</span>
